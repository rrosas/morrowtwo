...
class FormHtml {
	...
	public static function getLabel($formname, $el_name, $params = array()){
		...
		$_form = \Morrow\Core\Factory::load('Libraries\form');
		...
		$classname = 'formhtmlelement' . $display_type;
			...
			$display_obj = \Morrow\Core\Factory::load('Libraries\\' . $classname);
	...
	public static function getElement($formname, $el_name, $params = array()){
		...
		$classname = 'formhtmlelement' . $display_type;
			...
			$display_obj = \Morrow\Core\Factory::load('Libraries\formhtmlelement' . $default_dtype);
		}
